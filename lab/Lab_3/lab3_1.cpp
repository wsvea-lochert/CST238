/*
 * Title: lab3_1.cpp
 * Abstract: this program stores values as dollars and cents. and has functions to set the values, return the values
             and add more money on top of what they already have.
